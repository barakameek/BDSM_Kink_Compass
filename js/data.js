    ...
    {id: "taboo_autassassinophilia_rp_01", name: "Autassassinophilia Roleplay (Risk of Death Fantasy)", category_id: "taboo_conceptual", isTaboo: true, isHighRisk: true, description: "Sexual arousal from the fantasy of being killed or risking one's life, often in a specific scenario. This is PURELY FANTASY/ROLEPLAY.", common_terms: ["Erotic risk-of-death fantasy"], safety_notes: ["CRITICAL: ABSOLUTELY NO ACTUAL RISK TO LIFE. All scenarios are simulated with props and extreme safety. Focus is on psychological thrill. Safewords paramount. Extensive negotiation and trust. High potential for emotional intensity/fear. Not for unstable individuals. This is very different from suicidal ideation and should not be confused."], common_misconceptions: ["Person actually wants to die (It's an erotic fantasy about risk/powerlessness)."], related_kinks_ids: ["fear_play_01", "edge_play", "death_play_rp_01", "cnc_rp_01"]},
{
   ...
   {id: "impact_hair_pulling_01", name: "Hair Pulling (Consensual)", category_id: "impact", description: "Grabbing and pulling hair for control, sensation, or as part of dominance. Requires research on safe techniques.", common_terms: ["Research terms"], safety_notes: ["CRITICAL: Avoid yanking motions that can cause whiplash or scalp injury. Support head/neck. Discuss pain levels."], common_misconceptions: ["Research misconceptions"], related_kinks_ids: ["power_exchange"]},
    {id: "impact_pressure_points_01", name: "Pressure Point Control/Pain", category_id: "impact", isHighRisk: true, description: "Applying pressure to specific nerve points for pain or compliance. Requires anatomical knowledge.", common_terms: ["Research terms"], safety_notes: ["CRITICAL: Requires precise anatomical knowledge. Risk of nerve damage or unintended effects. Not for beginners."], common_misconceptions: ["Research misconceptions"], related_kinks_ids: ["sensation_play_general_01", "power_exchange"]},
    {id: "impact_breast_binding_impact_01", name: "Breast/Chest Binding with Impact", category_id: "impact", isHighRisk: true, description: "Binding breasts/chest tightly then applying impact. Combines bondage and impact.", common_terms: ["Research terms"], safety_notes: ["CRITICAL: Risk of breathing restriction from binding. Impact safety for chest area. Monitor closely."], common_misconceptions: ["Research misconceptions"], related_kinks_ids: ["bondage", "impact_body_01"]},
    {id: "impact_wooden_spoon_01", name: "Wooden Spoon (Impact)", category_id: "impact", description: "Using a wooden spoon for spanking or impact. Common household item used in play.", common_terms: [], safety_notes: ["CRITICAL: Can be very hard. Risk of deep bruising. Avoid bones/kidneys. Inspect for splinters."], common_misconceptions: ["Research misconceptions"], related_kinks_ids: ["spanking_01", "paddling_01"]},
    {id: "impact_ruler_01", name: "Ruler (Impact)", category_id: "impact", description: "Using a ruler (wooden, metal, plastic) for sharp, stinging impact, often in school-themed RP.", common_terms: ["School discipline"], safety_notes: ["CRITICAL: Metal/hard plastic rulers can cause significant pain/welts. Avoid edges. Avoid bones."], common_misconceptions: ["Research misconceptions"], related_kinks_ids: ["spanking_01", "teacher_student_rp_01"]},

    // More Bondage
    {id: "bondage_straitjacket_01", name: "Straitjacket", category_id: "bondage", description: "Using a straitjacket for extreme arm restraint and psychological effect.", common_terms: [], safety_notes: ["CRITICAL: Can be very hot and claustrophobic. Ensure proper fit. Monitor wearer for panic/overheating. Have release plan."], common_misconceptions: ["Research misconceptions"], related_kinks_ids: ["mummification_01", "sensory_deprivation_01"]},
    {id: "bondage_sleep_sack_01", name: "Sleep Sack / Body Bag Bondage", category_id: "bondage", description: "Enclosing a person in a restrictive sack or bag, limiting movement and sometimes senses.", common_terms: [], safety_notes: ["CRITICAL: AIRWAY. Ensure breathable material or clear air source. Risk of overheating/panic. Quick release essential."], common_misconceptions: ["Research misconceptions"], related_kinks_ids: ["mummification_01", "sensory_deprivation_01"]},
    {id: "bondage_medical_01", name: "Medical Restraints (e.g., Posey Vest)", category_id: "bondage", description: "Using actual or replica medical restraints for bondage scenarios.", common_terms: ["Posey", "Hospital bondage"], safety_notes: ["CRITICAL: Understand how real medical restraints work to use safely. Avoid positions that restrict breathing. Monitor for circulation/nerve issues."], common_misconceptions: ["Research misconceptions"], related_kinks_ids: ["medical_play", "cuffs_restraints_01"]},
    {id: "bondage_spreader_legs_arms_01", name: "Leg/Arm Spreader Bondage", category_id: "bondage", description: "Specifically using spreader bars or ties to keep legs and/or arms spread wide apart.", common_terms: [], safety_notes: ["CRITICAL: Avoid over-stretching joints/muscles. Monitor for discomfort. Allow for adjustments."], common_misconceptions: ["Research misconceptions"], related_kinks_ids: ["cuffs_restraints_01", "bondage_furniture_01"]},
    {id: "bondage_single_point_susp_01", name: "Single-Point Suspension", category_id: "bondage", isHighRisk: true, description: "A type of suspension where the body is hung from a single overhead anchor point, allowing for rotation. Extremely advanced.", common_terms: [], safety_notes: ["CRITICAL: ALL suspension safety applies, amplified. Requires expert rigging and spotting. High risk of uncontrolled spinning or injury."], common_misconceptions: ["Research misconceptions"], related_kinks_ids: ["suspension_01", "shibari_01"]},

    // More Power Exchange
    {id: "power_exchange_mind_games_01", name: "Mind Games (Consensual)", category_id: "power_exchange", isHighRisk: true, description: "Psychological manipulation, teasing, or challenges designed to exert control or test the submissive's wit/devotion within an agreed framework.", common_terms: ["Psych dom"], safety_notes: ["CRITICAL: Clear boundaries on topics and types of manipulation. Safewords essential. High potential for emotional distress if limits are crossed. Aftercare vital."], common_misconceptions: ["Research misconceptions"], related_kinks_ids: ["gaslighting_rp_01", "psychological"]},
    {id: "power_exchange_training_01", name: "Obedience/Submissive Training", category_id: "power_exchange", description: "Structured process where a dominant teaches/conditions a submissive in specific behaviors, responses, or protocols.", common_terms: ["Sub training"], safety_notes: ["CRITICAL: Methods must be consensual and ethical. Avoid abusive conditioning. Focus on positive reinforcement where possible. Clear goals and expectations."], common_misconceptions: ["Research misconceptions"], related_kinks_ids: ["protocol_play_01", "command_following_01"]},
    {id: "power_exchange_interrogation_01", name: "Interrogation (Power Exchange Focus)", category_id: "power_exchange", description: "Using interrogation as a method to exert power, test loyalty, or extract 'confessions' (real or roleplay) from a submissive.", common_terms: [], safety_notes: ["CRITICAL: See Interrogation RP. Define what information is 'at stake'. Limits on pressure. Safewords."], common_misconceptions: ["Research misconceptions"], related_kinks_ids: ["interrogation_rp_01", "psychological"]},
    {id: "power_exchange_denial_privileges_01", name: "Denial of Privileges", category_id: "power_exchange", description: "Withholding agreed-upon privileges (e.g., certain foods, activities, comforts, orgasm) as part of discipline or control.", common_terms: [], safety_notes: ["CRITICAL: Privileges and terms of denial must be pre-negotiated. Ensure denial doesn't impact essential health/safety. Clear path to regain privileges."], common_misconceptions: ["Research misconceptions"], related_kinks_ids: ["denial_orgasm_01", "protocol_play_01"]},
    {id: "power_exchange_human_pet_training_01", name: "Human Pet Training", category_id: "power_exchange", description: "Specific training protocols and conditioning for someone in a human pet role, beyond general pet play.", common_terms: [], safety_notes: ["CRITICAL: See Pet Play and Owner/Pet safety. Focus on specific 'tricks' or behaviors. Humane treatment always."], common_misconceptions: ["Research misconceptions"], related_kinks_ids: ["pet_play_01", "owner_pet_01", "command_following_01"]},
