...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function populateSummaryFilterControls() {
        ...
        const ratingTypes = { 'favorite': 'Favorites', 'want_to_try': 'Want to Try',  'like_it': 'Likes', 'curious_about': 'Curiosities', 'soft_limit': 'Soft Limits', 'hard_limit': 'Hard Limits', 'not_for_me': 'Not For Me' }; /* Added love_it */
    ...
    function renderSummaryForActiveProfile() { 
        ...
        const ratingOrder = ['favorite', 'love_it', 'want_to_try', 'like_it', 'curious_about', 'soft_limit', 'hard_limit', 'not_for_me', 'neutral'];
