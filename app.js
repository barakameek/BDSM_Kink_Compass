...
class TrackerApp {
  ...
  handleWindowClick(e){if(e.target===this.elements.modal)this.closeModal(this.elements.modal);if(e.target===this.elements.sfModal)this.sfClose();
  ...
  handleWindowKeydown(e){if(e.key==='Escape'){if(this.elements.modal?.style.display==='flex')this.closeModal(this.elements.modal);if(this.elements.sfModal?.style.display==='flex')this.sfClose();
